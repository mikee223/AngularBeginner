...
const routes: Routes = [
  ...
  { path: 'employeeList/:id', component: EmployeeDetailComponent }, // route with parameter { path: 'employeeList/:id', component: EmployeeDetailComponent }, // route with parameter
